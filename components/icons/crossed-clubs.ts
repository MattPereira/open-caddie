...
const shaftPath = "M12 21L16.5 10";
const gripPath =
...
const left = "translate(-2,0)";
const right = "translate(26,0) scale(-1,1)";

export const CrossedClubsIcon: IconSvgElement = [
  ["path", { d: headPath, ...stroke, transform: left, key: "0" }],
  ["path", { d: shaftPath, ...stroke, transform: left, key: "1" }],
  ["path", { d: gripPath, ...stroke, transform: left, key: "2" }],
  ["path", { d: headPath, ...stroke, transform: right, key: "3" }],
  ["path", { d: shaftPath, ...stroke, transform: right, key: "4" }],
  ["path", { d: gripPath, ...stroke, transform: right, key: "5" }],
];
